-- =============================================================================
-- Migrazione metadati Spring Batch 5.x -> 6.0 per PostgreSQL
--
...
-- La colonna JOB_INSTANCE_ID mantiene il DEFAULT nextval(): dopo la rinomina
-- PostgreSQL aggiorna da solo il riferimento, non serve ricrearlo.
